    ...
    <SafeAreaView className="flex-1 justify-between bg-white ">
      <View className="flex-col items-center ">
        <View className="flex-row w-full justify-start items-start mt-8 px-8">
          <Text className="text-3xl text-neutral-900">Welcome!</Text>
        </View>
        <View className="flex justify-center items-center mx-2 mb-4 pb-6 pt-2">
          <Text className="text-5xl font-bold text-center px-4">
        ...
        <View className="px-4 m-2">
          <Text className="mx-4 my-4 text-center text-3xl text-wrap">
            “Start Your Journey to Fluent, Confident Communication."
          </Text>
        </View>
        <TouchableOpacity onPress={handleGetStarted} activeOpacity={0.7}>
          <View className="mt-4 h-16 w-96 bg-blue-400 rounded-2xl items-center justify-center">
